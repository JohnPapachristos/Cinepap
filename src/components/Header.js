...
export const Header = () => {
  ...
  return (
    <header>      
      <nav className="bg-white border-b-2 border-white-200 px-2 sm:px-4 py-2 dark:bg-black dark:border-b-1 dark:border-white">
        <div className="flex flex-wrap justify-between items-center mx-auto">
          <Link to="/" className="flex items-center">
              <img src={Logo} className="mr-2 h-8 sm:h-9" alt="Papachio Logo" />
              <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white animate-bounce">Cinepap news</span>
          </Link>
